...
# Assistive Exoskeleton GUI Launcher
# This script launches the GUI with a clean environment, avoiding snap library conflicts

# Flujo recomendado para regenerar la GUI y compilar el paquete:
# conda activate ros2rl
# cd interfaz/src/ROS2/gui/gui
...
env -i \
    ...
    /opt/ros/jazzy/bin/ros2 run gui gui_assistive_exo