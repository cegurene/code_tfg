...
static const _MotionCommand_type_support_symbol_names_t _MotionCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rl_interfaces, msg, MotionCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rl_interfaces, msg, MotionCommand)),
  }
};
...
{
  return &::rl_interfaces::msg::rosidl_typesupport_cpp::MotionCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rl_interfaces, msg, MotionCommand)() {
  return get_message_type_support_handle<rl_interfaces::msg::MotionCommand>();
}
