"""RL_NODE_V5 - Reinforcement Learning Agent with Adjustable Torque Scaling
...
best_model_path = MODELS_DIR / 'checkpoint_1060864.pt'
...
class MinimalPublisher(Node):
    ...
    def __init__(self):
        ...
        print("")
        print("Para cambiar el escalado: Editar rl_node_v5.py línea ~40")
